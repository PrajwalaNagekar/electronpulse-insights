...
export const mockTasks: Task[] = [
  { id: 't1', title: 'Survey households in Jayanagar 4th Block', description: 'Complete door-to-door survey in 4th Block', region: 'Jayanagar 4th Block', households: 40, completedHouseholds: 15, deadline: '2026-03-11T18:00:00', status: 'in_progress', priority: 'high', assignedTo: 'v1' },
  { id: 't2', title: 'Cover Koramangala 3rd Block', description: 'Survey remaining households in 3rd Block', region: 'Koramangala 3rd Block', households: 35, completedHouseholds: 0, deadline: '2026-03-12T18:00:00', status: 'pending', priority: 'medium', assignedTo: 'v1' },
  { id: 't3', title: 'BTM Layout voter verification', description: 'Verify voter list accuracy in BTM Layout', region: 'BTM Layout 2nd Stage', households: 50, completedHouseholds: 0, deadline: '2026-03-13T18:00:00', status: 'pending', priority: 'high', assignedTo: 'v1' },
  { id: 't4', title: 'HSR Layout community meeting', description: 'Attend community meeting and collect feedback', region: 'HSR Layout Sector 2', households: 25, completedHouseholds: 0, deadline: '2026-03-14T18:00:00', status: 'pending', priority: 'low', assignedTo: 'v1' },
  { id: 't5', title: 'Madiwala slum area outreach', description: 'Visit slum area for outreach program', region: 'Madiwala', households: 60, completedHouseholds: 60, deadline: '2026-03-10T18:00:00', status: 'completed', priority: 'high', assignedTo: 'v1' },
];
...
export const mockNotifications: Notification[] = [
  ...
  { id: 'n2', title: 'Daily Target Reminder', message: 'You have 18 more surveys to complete today. Keep going!', type: 'reminder', read: false, timestamp: '2026-03-10T14:00:00' },

...
export default function SplashScreen() {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center h-full bg-white overflow-hidden">
      ...
      >
        <img src={logo} alt="LXN Logo" className="w-40 h-40 object-contain" />
        <motion.div
        ...
        >
          <h1 className="text-2xl font-bold font-display text-primary">ElectionInsight</h1>
          <p className="text-sm text-muted-foreground mt-1">Field App</p>
        </motion.div>
      </motion.div>
